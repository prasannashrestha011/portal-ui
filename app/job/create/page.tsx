...
import { ArrowLeft, BriefcaseBusiness, Check, Lightbulb, ShieldCheck } from "lucide-react";
import { JobForm } from "@/src/components/Job/CreateJobForm";
        ...
        <div className="min-h-screen bg-[#f3f2ef] pb-16 dark:bg-slate-950">
            <header className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
                <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                    <Link href="/job" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600 transition-colors hover:text-[#0a66c2] dark:text-slate-300">
                        <ArrowLeft className="size-4" />
                        Back to jobs
                    </Link>
                    <span className="inline-flex items-center gap-2 text-sm font-semibold text-slate-700 dark:text-slate-200">
                        <span className="grid size-8 place-items-center rounded-md bg-[#0a66c2] text-white">
